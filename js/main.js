...
function renderMaterials(materials, totalCost) {
    ...
    materials.forEach(mat => {
        const item = escapeHtml(mat.item);
        const cost = formatCurrency(mat.cost);
        html += `<li>${item} — <span class="cost">${cost}</span></li>`;
    });
    html += '</ul>';
